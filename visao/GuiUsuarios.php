...
<div class="conteudo">
    <div class="listagem" style="background: #fcfcfc; margin: 2em auto;width:85%;">
        ...
        <form class="form-inline" method="POST" action="#">
            <div>
                <input class="form-control mr-sm-2" type="text" name="filtro"  aria-label="Pesquisar">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!--<form method="POST" action="../controle/ControleUsuario.php?op=editar">-->
                        <a class="glyphicon glyphicon-pencil" name="id_edit" id="id_edit" href="../visao/GuiEditarUsuario.php?op=editar&id_usuario=<?=$usuario->getIdUsuario();?> " value="<?=$usuario->getIdUsuario()?>"></a>
                    <td><a class="glyphicon glyphicon-trash" href="../controle/ControleUsuario.php?op=excluir&id_usuario=<?=$usuario->getIdUsuario();?> "></a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
